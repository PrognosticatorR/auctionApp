...
contract AuctionContract {
    ...
    modifier contractIsDeedOwner(
        ...
        address deedOwner = Deed(_deedAddress).ownerOf(
            _deedId
        );
     ...
     */
    function getBidsCount(uint256 _auctionId)
        public
        view
        returns (uint256)
    {
     ...
     */
    function getAuctionsOf(address _owner) public view returns (uint256[]) {
    ...
    function createAuction(
        ...
        public
        contractIsDeedOwner(_deedAddress, _deedId)
        returns (bool)
    {
